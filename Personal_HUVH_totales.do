/*****************************************************************/
/* 
Ahora generamos una hoja de Excel para contar las vacunas pautadas y administradas
a trabajadores del HUVH.
Primero marcamos como trabajadores del HVUH todos los registros que hayan sido 
etiquetados así en alguna ocasión. 
Luego creamos una base de datos que contenga sólo a estos registros etiquetados
como trabajadores del HUVH (sólo el NHC y la etiqueta de trabajador del HUVH).
...
* Contamos los registros etiquetados como 'personal de la casa'.

tab personalcasa

* Ahora creamos una base de datos sólo con los trabajadores del HUVH.


gen hcw_huvh=1 if personalcasa=="Si"

keep if hcw_huvh==1

keep nhc hcw_huvh

save PersonalHUVHSetembre2018, replace
...
merge m:m nhc using PersonalHUVHSetembre2018

des

tab personalcasa hcw_huvh, missing
...
/************************************************************************/
/* 
Hacemos tablas sobre vacunas prescritas y administradas a trabajadores
 del HUVH y las exportamos a Excel.
...
vp_g64 if hcw_huvh==1, statistics(sum) col(stat) save
...
va_xrp va_xrpv iga_hb iga_ra iga_in iga_t va_g60 va_g61 va_g62 va_g63 va_g64 ///
 if hcw_huvh==1, statistics(sum) col(stat) save
...
/*
putexcel set Activitat_vacunes_2018, sheet("Total personal HUVH") modify 

putexcel A1=("Personal de l'HUVH"), font("Verdana", 14) bold hcenter 
